...
app.get('/', (req, res) => {
  res.status(200)
  res.send(`Lark Webhook sample successfully running. Set this URL with the /webhook path as your apps Event notification endpoint URL.`)
})
...
app.post('/webhook', (req, res) => {
  ...
  response = { message: 'Authorized request to Lark Webhook sample.', status: 200 }
